...
require $root.'/View/Templates/DefaultNav.php'; ?>
  ...
  <div id="wrapper">
      ...
      <div class="container">
        ...
        <div class="col-xs-12 col-md-8">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
            <input class="form-control" type="date" id="data_nascimento" name="data_nascimento" placeholder="Ex. 01/01/1999" value="<?php $data = implode("/",array_reverse(explode("-", $row["data_nascimento"]))); echo $data; ?>">
            </div>
    ...
    <!-- Valida cadastro -->
    <script src="/public/js/validate/empresario.edit.validate.js"></script>
    <!-- masked input -->
