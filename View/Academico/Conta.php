		  ...
		  <div class="row">
			<div class="col-xs-12 col-md-8">
			  <form class="form-horizontal" action="" method="POST">
				...
				<div class="col-md-8">
				  <input class="form-control" type="text" name="instituicao" placeholder="Ex. Universidade de São Paulo" value="<?php echo $row["instituicao"] ?>">
				</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">Matrícula</label>
				<div class="col-md-4">
				  <input class="form-control" type="text" name="matricula" placeholder="Ex. 200020209" value="<?php echo $row["matricula"] ?>">
				</div>
				</div>
				<div class="form-group">
