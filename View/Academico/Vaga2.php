			...
			<div class="container">
                <div class="col-md-3">
                    <div class="alert alert-success alert-dismissible" role="alert">
                        ...
                        </button><a href='/View/Academico/Vagaaa.php' title='Confirmar'><u>Candidatar-se à Vaga</u></a>
                    </div>
				</div>
				<div class="col-md-3">
                    <div class="alert alert-danger alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button><a href='/View/Academico/Vaga.php' title='Voltar'><u>Outras Vagas Disponíveis</u></a>
                    </div>
                </div>                
            </div>
          </form>
